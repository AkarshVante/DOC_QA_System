...
# Set page config with the sidebar permanently expanded
...
CHUNK_OVERLAP = 200
RETRIEVE_K = 4
GEMINI_PREFERRED = ["gemini-1.5-flash", "gemini-pro"]

# ---------- UI & Styling with Permanent Sidebar ----------
UI_STYLES = """
<style>
    ...
    if LANGCHAIN_AVAILABLE and google_api_key:
        for model_name in GEMINI_PREFERRED:
            try:
                ...
                st.warning(f"Model '{model_name}' failed with error: {e}. Trying next...")
                continue
